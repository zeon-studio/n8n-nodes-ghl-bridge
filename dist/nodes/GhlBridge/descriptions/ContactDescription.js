...
exports.contactOperations = {
    ...
    options: [
        ...
        { name: "Create or Update", value: "upsert", action: "Upsert a contact" },
...
exports.contactFields = [
    // ── GET / DELETE / ADD TAGS / REMOVE TAGS ──────────────────────────────
    {
        ...
        displayOptions: {
            show: {
                resource: ["contact"],
                operation: ["get", "delete", "update", "addTags", "removeTags"],
            },
        },
    ...
    // ── TAGS ────────────────────────────────────────────────────────────────
    {
        ...
        default: "",
        displayOptions: {
            show: { resource: ["contact"], operation: ["addTags", "removeTags"] },
        },
